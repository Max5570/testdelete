...
namespace TrainRunnerServer.Migrations
{
    ...
    [Migration("20250511101039_telegram_bot_referal_relation")]
    partial class telegram_bot_referal_relation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainRunnerServer.Models.StaticDataModels.TrainPassiveRewardModel", b =>
                {
                    ...
                    b.Property<int>("CurrencyPerMinute")
                        .HasColumnType("integer");

                    b.Property<int>("ResourceType")
                        .HasColumnType("integer");

                    b.Property<int>("TrainModelId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("TrainModelId");

                    b.ToTable("TrainRewards");
                });

            modelBuilder.Entity("TrainRunnerServer.Models.TelegramChatUserModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TelegramReferalRelation");
                });
            ...
            modelBuilder.Entity("TrainRunnerServer.Models.UserModel", b =>
                {
                    ...
                    b.Property<DateTime>("LastTimeDailyRewardClaimed")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("LastTimePassiveRewardClaimed")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TrainRunnerServer.Models.UserModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TrainRunnerServer.Models.StaticDataModels.TrainPassiveRewardModel", b =>
                {
                    b.HasOne("TrainRunnerServer.Models.StaticDataModels.TrainModel", "TrainModel")
                        .WithMany("PassiveRewards")
                        .HasForeignKey("TrainModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TrainModel");
                });
